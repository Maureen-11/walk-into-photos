...
const lightingPreset=manifest.pixel_spec?.lighting_preset||'neutral';const lighting={
  ...
  indoor_pixel_detail_v5:{background:'#182237',sky:'#ffedc9',ground:'#303642',hemi:0.50,ambient:0.24,key:'#ffd09a',keyIntensity:2.14,fill:'#8eafd0',fillIntensity:0.12,shadows:true,emissiveLift:0.006},
