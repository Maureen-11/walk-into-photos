...
from app.services.pixel_scene import (
    build_pixel_building_v06,
    build_pixel_corridor_v07,
    build_pixel_living_v07,
    build_pixel_nature_v04,
    build_pixel_street_v06,
)


def main() -> int:
    parser = argparse.ArgumentParser(description="Build isolated Q03 r3 pixel-detail candidates without changing the default route.")
    ...
    builders = {
        "living": build_pixel_living_v07,
        "corridor": build_pixel_corridor_v07,
        "nature": build_pixel_nature_v04,
        "street": build_pixel_street_v06,
        "building": build_pixel_building_v06,
    }
