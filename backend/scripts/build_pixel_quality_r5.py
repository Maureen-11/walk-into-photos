...
from app.services.pixel_scene import (
    build_pixel_building_v08,
    build_pixel_corridor_v09,
    build_pixel_living_v09,
    build_pixel_nature_v06,
    build_pixel_street_v08,
)


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Build isolated Q03 r5 material-contrast candidates without changing the default route."
    )
    ...
    builders = {
        "living": build_pixel_living_v09,
        "corridor": build_pixel_corridor_v09,
        "nature": build_pixel_nature_v06,
        "street": build_pixel_street_v08,
        "building": build_pixel_building_v08,
    }
