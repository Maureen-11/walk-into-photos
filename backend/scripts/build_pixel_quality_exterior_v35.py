...
from app.services.pixel_scene import build_pixel_building_v35, build_pixel_street_v35


def main() -> int:
    parser = argparse.ArgumentParser(description="Build isolated Q03 V35 exterior semantic-composition candidates.")
    ...
    default_id = "pixel-q05-r35-s01" if args.profile == "s01" else "pixel-q05-r35-b01"
    builder = build_pixel_street_v35 if args.profile == "s01" else build_pixel_building_v35
    ...
    print(json.dumps({
        ...
        "geometry_inherited_from": "pixel-v34",
    }, ensure_ascii=False))
    return 0
