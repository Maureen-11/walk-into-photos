...
from app.services.pixel_scene import build_pixel_corridor_v25, build_pixel_living_v25


def main() -> int:
    parser = argparse.ArgumentParser(description="Build isolated Q05 indoor lighting candidates for I01 or I02.")
    ...
    default_id = "pixel-q05-r25-i01" if args.profile == "i01" else "pixel-q05-r25-i02"
    builder = build_pixel_corridor_v25 if args.profile == "i01" else build_pixel_living_v25
    ...
    print(json.dumps({
        ...
        "geometry_inherited_from": "pixel-v17" if args.profile == "i01" else "pixel-v16",
    }, ensure_ascii=False))
    return 0
