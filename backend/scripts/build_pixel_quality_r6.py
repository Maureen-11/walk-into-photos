...
from app.services.pixel_scene import (
    build_pixel_building_v09,
    build_pixel_corridor_v10,
    build_pixel_living_v10,
    build_pixel_nature_v07,
    build_pixel_street_v09,
)


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Build isolated Q03 r6 start-composition candidates without changing the default route."
    )
    ...
    builders = {
        "living": build_pixel_living_v10,
        "corridor": build_pixel_corridor_v10,
        "nature": build_pixel_nature_v07,
        "street": build_pixel_street_v09,
        "building": build_pixel_building_v09,
    }
