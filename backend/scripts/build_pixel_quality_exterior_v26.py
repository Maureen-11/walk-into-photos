...
from app.services.pixel_scene import build_pixel_building_v26, build_pixel_street_v26


def main() -> int:
    parser = argparse.ArgumentParser(description="Build isolated Q05 exterior lighting candidates for S01 or B01.")
    ...
    default_id = "pixel-q05-r26-s01" if args.profile == "s01" else "pixel-q05-r26-b01"
    builder = build_pixel_street_v26 if args.profile == "s01" else build_pixel_building_v26
    ...
    print(json.dumps({
        ...
        "geometry_inherited_from": "pixel-v19" if args.profile == "s01" else "pixel-v20",
    }, ensure_ascii=False))
    return 0
