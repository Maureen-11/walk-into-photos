...
from app.services.pixel_scene import build_pixel_corridor_v02, build_pixel_living_v02


def main() -> int:
    parser = argparse.ArgumentParser(description="Build a V02 fine-detail pixel-style indoor candidate.")
    ...
    if args.profile == "corridor":
        payload = build_pixel_corridor_v02(args.input, args.output, args.scene_id)
    else:
        payload = build_pixel_living_v02(args.input, args.output, args.scene_id)
