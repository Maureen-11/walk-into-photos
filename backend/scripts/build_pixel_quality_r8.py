...
from app.services.pixel_scene import (
    build_pixel_building_v11,
    build_pixel_corridor_v12,
    build_pixel_living_v12,
    build_pixel_nature_v09,
    build_pixel_street_v11,
)


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Build isolated Q03 v12 image-specific indoor detail candidates without changing the default route."
    )
    ...
    builders = {
        "living": build_pixel_living_v12,
        "corridor": build_pixel_corridor_v12,
        "nature": build_pixel_nature_v09,
        "street": build_pixel_street_v11,
        "building": build_pixel_building_v11,
    }
