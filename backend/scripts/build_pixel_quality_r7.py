...
from app.services.pixel_scene import (
    build_pixel_building_v10,
    build_pixel_corridor_v11,
    build_pixel_living_v11,
    build_pixel_nature_v08,
    build_pixel_street_v10,
)


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Build isolated Q03 v11 lighting candidates without changing the default route."
    )
    ...
    builders = {
        "living": build_pixel_living_v11,
        "corridor": build_pixel_corridor_v11,
        "nature": build_pixel_nature_v08,
        "street": build_pixel_street_v10,
        "building": build_pixel_building_v10,
    }
