...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build Q03 V46 semantic micro-surface precision candidates.")
    ...
    defaults = {
        "i01": (build_pixel_corridor_v46, "pixel-q05-r46-i01"),
        "i02": (build_pixel_living_v46, "pixel-q05-r46-i02"),
        "n01": (build_pixel_nature_v46, "pixel-q05-r46-n01"),
        "s01": (build_pixel_street_v46, "pixel-q05-r46-s01"),
        "b01": (build_pixel_building_v46, "pixel-q05-r46-b01"),
    }
